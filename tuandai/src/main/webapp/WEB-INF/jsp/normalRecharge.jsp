...
<div class="re-tab-content one-pay  " id="onepay">
<ul id="bankListDIV">
</ul>
</div>
</div>
...
<input class="text-input" type="text" placeholder="输入充值金额" value="0" onkeypress="return KeyPressNum(this,event);" id="t_money"><span id="spnRechargeAmountBig" style="margin-left: 20px;"></span>
<span class="ml10">最低充值金额100元</span>
<div class="error-mes tip" id="tip"></div>
</div>
<div class="btn">
<a class="td-btn-1 td-btn-1-or f16" style="cursor: pointer;" target="_blank" id="confirmRecharge" href="normalRecharge.html">充值</a>
</div>
</div>
<div class="bank-pay-limit" id="eBankPayLimitDiv" style="display: block;">
<div class="limit-bankname" id="selBankName">
<img src="images/gsyh1.jpg" alt="">
</div>
<table class="limit-bank-table" id="eBankPayLimitTable" width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
<tbody><tr>
<th width="22%" bgcolor="#f9f9f9">网银类型</th>
<th width="19.5%" bgcolor="#f9f9f9">单笔限额（元）</th>
<th width="19.5%" bgcolor="#f9f9f9">单日限额（元）</th>
<th class="limit-intro" width="39%" bgcolor="#f9f9f9" style="display: none;">说明</th>
</tr>
<tr name="ICBC"><td class="text-333" width="33.33%">e支付</td><td width="33.33%">1万</td><td width="33.33%">1万</td><td class="limit-intro1" width="33.33%" style="display: none;">--</td></tr><tr name="ICBC"><td class="text-333" width="33.33%">网银支付</td><td width="33.33%">500万</td><td width="33.33%">不限额</td><td class="limit-intro1" width="33.33%" style="display: none;">--</td></tr></tbody></table>
<div class="limit-bank-tips">注意：以上额度均表示最高支持额度，用户实际额度取决于商户限额、风控限额、用户银行卡本身限额取最低限额</div>
</div>
</div>
<div class="account_notice clearfloat">
<h2>温馨提示</h2>
<p>
1. 如果您充值是用于结清操作，建议暂停自动投标，以免资金被投资出去导致不够资金结清；<br> 2. 23：45分至次日00：45分为银行对账时间，建议避开该时段充值，以免出现到账延迟。
</p>
</div>
</div>
</div>
...
<a href="" id="aOpen" class="btn" target="_blank" style="display: block;">马上升级</a>
</div>
</div>
