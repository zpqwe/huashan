...
<jsp:include page="ChongZhiType.jsp"></jsp:include>
<div class="recharge-content">
<div class="re-tabbox" id="re-tabbox">
<div class="re-tab-content two-pay " id="twopay">
<input type="hidden" id="KJsel" value="0">
<input type="hidden" id="hd_bankcode" value="">
<ul id="rechargeBankCode">
<li class="blanklist">
<p>
<img src="images/add_bank02.gif" alt="">
<span></span>
</p>
</li>
</ul>
<div class="pay-intro">
<p class="f12">充值限额：单笔限额<span>￥0</span>、每日限额<span>￥</span>、每月限额<span>￥</span></p>
<p class="f12">工商、邮储、建设、浦发及中国银行需开通银联无卡支付功能，方可进行快捷支付。&nbsp;&nbsp;<a href="#" >开通&gt;&gt;</a></p>
</div>
</div>
</div>
...
<input class="text-input" type="text" placeholder="输入充值金额" value=""  id="t_money" name="t_money"><span id="spnRechargeAmountBig" style="margin-left: 20px;"></span>
<span class="ml10">最低充值金额100元</span>
<div class="error-mes tip" id="tip">
<div class="reg_wrong" style="display: none;" id="reg">
 <img src='images/zhuce2.gif' style='margin:2px;'>
 <span id="sp"></span>
</div>
</div>
</div>
<script type="text/javascript" >
  ...
  function jump(){
	...
	var1 = document.getElementById ("t_money").value;//获取该text对象
	if(var1<100){
		document.getElementById("reg").style.display="block";
		/* var d1=document.getElementById("reg");
		var img=document.createElement("img");
		img.src="..images/zhuce2.gifg";
		img.style="margin:2px;";
		d1.appendChild(img); */
		document.getElementById("sp").innerHTML="最低充值金额为100元";
	}else if(isNaN(var1)){
		document.getElementById("reg").style.display="block";
		document.getElementById("sp").innerHTML=" 请输入正确的金额，小数点后最多2位数。";
	}else{
	var type=document.getElementById("kuai").innerHTML;
	alert(type)
	location.href="ChongZhi?t_money="+var1+"&kuai="+type;
	}
	}

</script>
<div class="btn">
<a class="td-btn-1 td-btn-1-or f16" style="cursor: pointer;"  id="shortcutRecharge" href="javascript:jump()" >充值</a>
</div>
</div>
</div>
...
<h2>温馨提示</h2>
<p>
1. 如果您充值是用于结清操作，建议暂停自动投标，以免资金被投资出去导致不够资金结清；<br>
2. 23：45分至次日00：45分为银行对账时间，建议避开该时段充值，以免出现到账延迟。
</p>
</div>
</div>
</div>
...
<a href="welist.html" class="btn">充值成功，马上投资</a>
</div>
<a class="question" href="javascript:void(0);" >充值遇到问题</a>
</div>
</div>
...
<div class="right">
<a rel="nofollow" href="Recharge.html"  class="charge">去充值</a>
<p>
...
<a href="" id="aOpen" class="btn"  style="display: block;">马上升级</a>
</div>
</div>
...
<a href="" id="aOpen" class="btn" >绑定银行卡</a>
</div>
</div>
...
<a style="color:red;text-decoration: underline;" href="javascript:;" onclick="javascript:window.open(39);" >
遇到问题，联系客服
</a>
</div>
</div>
