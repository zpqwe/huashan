...
<!-- saved from url=(0049)https://www.tuandai.com/member/account_useravatar -->
...
<li><a href="#" class="font-14 font-orange">[<span>购买超级会员</span>]</a></li>
</ul>
</div>
</div>
</div>
...
<div class="box-padding margin-top-10 clearfloat Picture_upload">
<div class="nav_top">
<ul class="nav_title">
<li class="tab_title_b" onclick="javascript:window.location.href=${pageContext.request.contextPath}/account_userdetailinfo">
<a href="${pageContext.request.contextPath}/account_userdetailinfo">个人信息</a>
</li>
...
温馨提示：您可以通过修改用户头像来展示自己 ！
</div>
<div class="up-pic-btn">
<form id="headsum" action="${pageContext.request.contextPath}/updatemeheadImg" method="post"  enctype="multipart/form-data">
<a href="javascript:;" class="a-upload Local_image"><input type="file" name="fuImage" id="fuImage" class="upfile"></a>
</form>
<br>
<a href="javascript:;" class="margin-top-20 System_image" onclick="layerBox(&#39;.face-img&#39;,&#39;50px&#39;)"></a>
</div>

<div class="face-img" style="display: none">
<i class="close"></i>
<p class="font-14 margin-bottom-5">选择系统头像</p>
<ul class="clearfloat system-face">
<li class="selected">
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface01.jpg" alt="" imgid="1"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface02.jpg" alt="" imgid="2"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface03.jpg" alt="" imgid="3"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface04.jpg" alt="" imgid="4"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface05.jpg" alt="" imgid="5"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface06.jpg" alt="" imgid="6"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface07.jpg" alt="" imgid="7"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface08.jpg" alt="" imgid="8"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface09.jpg" alt="" imgid="9"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface10.jpg" alt="" imgid="10"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface11.jpg" alt="" imgid="11"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface12.jpg" alt="" imgid="12"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface13.jpg" alt="" imgid="13"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface14.jpg" alt="" imgid="14"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface15.jpg" alt="" imgid="15"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface16.jpg" alt="" imgid="16"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface17.jpg" alt="" imgid="17"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface18.jpg" alt="" imgid="18"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface19.jpg" alt="" imgid="19"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface20.jpg" alt="" imgid="20"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface21.jpg" alt="" imgid="21"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface22.jpg" alt="" imgid="22"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface23.jpg" alt="" imgid="23"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface24.jpg" alt="" imgid="24"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface25.jpg" alt="" imgid="25"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface26.jpg" alt="" imgid="26"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface27.jpg" alt="" imgid="27"></li>
<li>
<img src="${applicationScope.IMG_SERVER_NAME}/images/headImg/tdface28.jpg" alt="" imgid="28"></li>
</ul>
<div class="face-save clearfloat">
<p class="font-14 margin-bottom-5">各尺寸头像预览</p>
<div class="face face1">
<img src="images/tdface01.jpg" alt="">
</div>
...
<li>
<a href="javascript:;" onclick="javascript:window.open(&#39;//info.tuandai.com/help/index.html&#39;)">
<i class="tdw-icons i-tool-help"></i>
<p>帮助<br>中心</p>
</a>
</li>
<li>
<a href="javascript:;" onclick="javascript:window.open(&#39;//info.tuandai.com/tool/int_fina.html&#39;);">
...
<script>
        ...
        $(function () {
            ...
            // 点击系统头像.
            $('.face-img').find('li').click(function () {
                $(this).parent().find('li').removeClass('selected');
                $(this).addClass('selected');
                $('.face-img').find('.face').html($(this).html());
            });
            // 保存系统头像.
            $(".submit-btn").click(function () {
                var image = $(".face-img").find("li.selected img").attr("src");
                var imgid = $(".face-img").find("li.selected img").attr("imgid");
                var src =$(".face-img img")[imgid-1].src;
                noticeWindow(newTitle, "您好，您确认更换头像吗？", "确定", function () {
                    closeLoadingWindows();
                    $.ajax({
                        ...
                        $("img#baseBody_body_body_headimg").attr("src", image);
                    	},
                    	error:function(){
                    		alert("请求失败")
                    	}
                    })
                   /*  $.post("${pageContext.request.contextPath}/uploadHeadImage", 
                    {sysImg: src}, 
                    function (result) {
                        $('.layer-box').find('.close').click();
                    }, function (json) {
...
//                    $.post("/member/ajaxCross/ajax_files.ashx", { Cmd: "UpdateSysAvatar", AvatarUrl: imgid },
//                        function (data) {
//                            if (data == "2") {
//                                $('.layer-box').find('.close').click();
//                                $("img[id$='baseBody_body_body_headimg']").attr("src", image);
//                            }
//                        });
                });
            });
        ...
        //绑定上传图片事件
        function upload() {
            $("#fuImage").unbind("change");
            noticeWindow(newTitle, "图片上传中...");
            $.ajaxFileUpload({
                url: '${pageContext.request.contextPath}/updatemeheadImg',
                secureuri: false,
                fileElementId: 'fuImage',
                dataType: 'text',
                success: function (data) {
                $("img#baseBody_body_body_headimg").attr("src",data);
                 noticeWindow(newTitle, "图片上传成功", "确定", closeLoadingWindows);
                  $('.layer-box').find('.close').click();
                    /* if (data == "2") {
                        //globalDialog(newTitle, "您好，上传失败，不支持上传非jpg、gif、png格式图片！", "", "1");
                        noticeWindow(newTitle, "您好，上传失败，不支持上传非jpg、gif、png格式图片！", "确定", closeLoadingWindows);
                    } else if (data == "3") {
                        //globalDialog(newTitle, "大于512K！", "", "1");
                        noticeWindow(newTitle, "大于512K！", "确定", closeLoadingWindows);
                    } else if (data == "0") {
                        //globalDialog(newTitle, "您好，上传失败，请重试！", "", "1");
                        noticeWindow(newTitle, "您好，上传失败，请重试！", "确定", closeLoadingWindows);
                    }
                    else {
                    } */
                    /* var i = data.indexOf('{'), j = data.lastIndexOf('}');
                    var json = JSON.parse(data.substring(i, j + 1));
//                    console.info(JSON.stringify(json));
                    if(json.code) {
                        noticeWindow(newTitle, json.message, "确定", closeLoadingWindows);
                        return;
                    }
                    $("#fuImage").val("");
                    $("img#baseBody_body_body_headimg").attr("src", json.data + "?v=" + (new Date()).getTime());
                    //globalDialog(newTitle, "图片上传成功", "", "1");
                    noticeWindow(newTitle, "图片上传成功", "确定", closeLoadingWindows);
                    $('.layer-box').find('.close').click(); */
                },
                error: function (data, status, e) {
                    console.error('data: ' + data + '   status: ' + status + '   e: ' + e);
                    //globalDialog(newTitle, "您好，上传失败，请重试！", "", "1");
                    noticeWindow(newTitle, "您好，上传失败，请重试！", "确定", closeLoadingWindows);
                }
            });
        ...
        /*function ChangeThirdParty(type) {
            var lblType = 'userBasicInfo.ThirdPartyType';
            if (lblType == "0" && type == 1) {
                //globalDialog(newTitle, "您还没有绑定过QQ账号登录，不能进行解除绑定操作！", "", "1");
                noticeWindow(newTitle,"您还没有绑定过QQ账号登录，不能进行解除绑定操作！","确定",closeLoadingWindows);
            }
            if (lblType == "0" && type == 2) {
                //globalDialog(newTitle, "您还没有绑定过微博账号登录，不能进行解除绑定操作！", "", "1");
                noticeWindow(newTitle,"您还没有绑定过微博账号登录，不能进行解除绑定操作！","确定",closeLoadingWindows);
            }
            $.ajax({
                type: "POST",
                url: "/member/ajaxCross/ajax.ashx",
                dataType: "json",
                data: { Cmd: "ChangeThirdParty" },
                success: function (json) {
                    var d = json.result;
                    if (parseInt(d) == -100) { window.location.href = "/View/NoticeMessage?status=2"; }
                    else if (parseInt(d) == -99) { window.location.href = "/u/login?ReturnUrl=" + window.location.href; }
                    else if (d == "1") {
                        //globalDialog(newTitle, "您好，解除绑定成功！", location.href, "1");
                        noticeWindow(newTitle,"您好，解除绑定成功！","确定",closeLoadingWindows);
                    } else {
                        //globalDialog(newTitle, "您好，操作失败，请联系客服！", location.href, "1");
                        noticeWindow(newTitle,"您好，操作失败，请联系客服！","确定",closeLoadingWindows);
                    }
                },
