...
%>
<!DOCTYPE html>
<!-- saved from url=(0053)需删除或修改www.tuandai.com/member/account_changenickname -->
...
<div class="name">
<p class="font-14 font-333 fw">您好，<span class="yonghuming font-orange2">${user.username}</span>！尽情享受宁静的时光吧
</p>
</div>
...
<ul>
<li class="font-14 font-9993">昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称：${user.nickname}</li>
<li class="font-14 font-9993">会员等级：<c:if test="${user.usergrade==1}">普通会员</c:if></li>
<li class="font-14 font-9993">会员期限：终身</li>
<li class="font-14 font-9993 no1">安全认证：
<a href="x">
<i style="background: url(&#39;images/icon2.png&#39;)<c:if test="${user.truename!=null}">0px -24px;</c:if><c:if test="${user.truename==null}">0px 0px;</c:if>" title="实名认证"></i>
...
<ul>
<li><a href="${pageContext.request.contextPath}/account_changenickname" class="font-14 font-orange">[修改昵称]</a>
</li>
...
<div class="account_notice margin-top-20 clearfloat margin-bottom-20">
<h2>温馨提示：昵称是您在团贷网上个性化的显示，也能更好的保护您账号的安全。</h2>
<p>
1、昵称可以是2-12位的中文或字母、数字、下划线的组合。<br>
2、昵称初始是与用户名相同的，您可以给自己修改一个更加个性化的昵称。
</p>
</div>
<div style="display: none;" class="alertDiv">
<ul style="display: block;">
</ul>
</div>
<div class="content margin-top-10" style="height: auto; min-height: 550px; overflow: hidden; background: #fff !important;">
<div style="width: 100%; height: auto; margin-bottom: 20px; margin-top: 15px; overflow: hidden">
<table cellpadding="0" cellspacing="0" style="width: 726px; float: left; padding: 0px; border-collapse: collapse; text-align: left;" id="formTb">
<tbody><tr>
<td class="tdTitle">用户名：
</td>
<td class="tdContent">
...
<td class="tdContent">
<input type="text" id="txtNickName" name="txtNickName" class="input-text2" value="${user.nickname}">
...
<input type="button" id="btn_set" onclick="UpdateNickName()" value="提交更新" class="submit-btn font-16" style="height: 40px; width: 100px;">
<input type="button" onclick="location.href=location.href;" value="取消" class="submit-btn font-16" style="background: #999; margin-left: 20px; height: 40px;">
</div>
</div>
</div>
</div>
...
<script type="text/javascript" src="js/account_changenickname.js"></script>
<script type="text/javascript" src="js/cgt_common.js"></script>
<script>
        /*<![CDATA[*/
//        var IsOpenCGT = '1';//是否开通存管通
...
//        var backUrlClose = "";
        ...
        function UpdateNickName() {
            ...
            if("${user.nickname}"==$("#txtNickName").val()){
            	addErr('昵称没有变化');
            }
            if (hasErr()) {
                showErr();
            ...
            $.ajax({
            	url:"${pageContext.request.contextPath}/updatenickname",
            	type:"post",
            ...
            /* $.common.post("${pageContext.request.contextPath}/updatenickname", {nickName: nickName}, function (data) {
                noticeWindow(newTitle, "您好，昵称修改成功！", location.href);
            }, function (json) {
                if(json.error) {
                    return noticeWindow(newTitle, "您好，操作失败，请联系客服！", location.href);
                }
                addErr(json.message);
                showErr();
            }); */
...
//                $.ajax({
//                    type: "POST",
//                    url: "/member/updateUserNickName",
//                    dataType: "json",
//                    data: { nickName: nickName },
//                    success: function (json) {
//                        var d = json.result;
//                        if (parseInt(d) == -100) { window.location.href = "/View/NoticeMessage?status=2"; }
//                        if (parseInt(d) == -99) { window.location.href = "/u/login?ReturnUrl=" + window.location.href; }
//                        if (d == "-1") {
//                            addErr('修改失败：用户参数错误！');
//                            showErr();
//                            return;
...
//                        } else if (d == "2") {
//                            if (IsOpenCGT != "1") {
//                                //globalDialog(newTitle, "您好，昵称修改成功！您的交易密码还未修改，点击确定后转到首次交易密码设置。", "/member/Validate/index.aspx", "1");
//                                noticeWindow(newTitle, "您好，昵称修改成功！您的交易密码还未修改，点击确定后转到首次交易密码设置。", "/member/Validate/index.aspx");
//                            }
//                            else {
//                                noticeWindow(newTitle, "您好，昵称修改成功！", location.href);
//                            }
...
<div id="waf_nc_block" style="display: none;"><div class="waf-nc-mask"></div><div id="WAF_NC_WRAPPER" class="waf-nc-wrapper"><img class="waf-nc-icon" src="images/TB1_3FrKVXXXXbdXXXXXXXXXXXX-129-128.png" alt="" height="20" width="20"><p class="waf-nc-title">安全验证</p><div class="waf-nc-splitter"></div><p class="waf-nc-description">请完成以下验证后继续操作：</p><div id="nocaptcha"></div></div></div><img src="images/SingleLogin.ashx" style="display: none;"></body></html>