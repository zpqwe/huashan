...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="${pageContext.request.contextPath }/pay/alipay.trade.page.pay" method=post
			target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>姓名  ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" value="${tuser.truename }"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
		...
		<form name=tradequery action="${pageContext.request.contextPath }/pay/alipay.trade.query" method=post
			target="_blank">
		...
		<form name=traderefund action="${pageContext.request.contextPath }/pay/alipay.trade.refund" method=post
			target="_blank">
		...
		<form name=traderefundquery
			action="${pageContext.request.contextPath}/pay/alipay.trade.fastpay.refund.query" method=post
			target="_blank">
		...
		<!-- 交易关闭 -->
		<form name=tradeclose action="${pageContext.request.contextPath}/pay/alipay.trade.close" method=post
			target="_blank">
