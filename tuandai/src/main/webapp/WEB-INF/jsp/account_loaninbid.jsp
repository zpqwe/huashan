...
<a href="javascript:;">进行中的投资</a>
</li>
<li class="tab_title_b" onclick="javascript:window.location.href=account_loanincomplete.html;">
<a href="${pageContext.request.contextPath}/account_loanincomplete">已完成的投资</a>
</li>
...
<a href="account_loanReturnPlanList.html">查看回款计划</a>
</div>
</div>
<dl class="account_screen margin-top-20 ">
<dt>筛选：</dt>


<input type="text" id="sirstate" value="" hidden/>
<dd id="sortA">
<a class="screen_now" href="javascript:void(0)" name="全部">全部(${page.totalCount})</a>
<a href="javascript:void(0)" name="正常回款">正常回款(${tsi.lists[0]})</a>
<a href="javascript:void(0)" name="逾期">逾期(${tsi.lists[1]})</a>
<a href="javascript:void(0)" name="投标中">投标中(${tsi.lists[2]})</a>
<a href="javascript:void(0)" name="流标">流标(${tsi.lists[3]})</a>
</dd>
</dl>
...
function changeDateFormat(d) {
 ...
 var min = date.getMinutes()< 10 ? "0" + date.getMinutes() : date.getMinutes();
	...
	function myAjax(){
		$.ajax({
			     "url":"${pageContext.request.contextPath}/tsiRecordAjax", 
			     "type":"post", 
