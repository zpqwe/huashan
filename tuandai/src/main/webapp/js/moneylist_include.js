                ...
                for (var J = 1; J <= 12; J++) {
                    ...
                    for (var i = 0; i < incomedata.length; i++) {
                        if (incomedata[i].YearMonth == oldyear + "-" + (J >= 10 ? J : "0" + J)) {
                            ...
                            switch (index) {
                                case 0:
                                    p_data.push(parseFloat(Round2(parseFloat(incomedata[i].InterestAmout_1 + incomedata[i].InterestAmout_2 + incomedata[i].InterestAmout_3)+ parseFloat(incomedata[i].PenaltyAmount_3))));//+ incomedata[i].ReceiveValue
                                    break;
                                case 1:
                                ...
                                case 2:
                                    ...
                                    break;
                                case 3:
                                    p_data.push(parseFloat(Round2(parseFloat(incomedata[i].InterestAmout_3)+ parseFloat(incomedata[i].PenaltyAmount_3))));
                                    break;
                                case 4:
                                    p_data.push(parseFloat(Round2(parseFloat(incomedata[i].ReceiveValue))));
                                    break;
                            }
                            break;
                        }
                ...
                for (var m = 1; m <= 12; m++) {
                    ...
                    for (var i = 0; i < payoutdata.length; i++) {
                        if (payoutdata[i].YearMonth == oldyear1 + "-" + (m >= 10 ? m : "0" + m)) {
                            ...
                            switch (index) {
                                case 0:
                                    p_data.push(parseFloat(Round2(parseFloat(payoutdata[i].InterestAmount_2))));
                                    break;
                                case 1:
                                    p_data.push(parseFloat(Round2(parseFloat(payoutdata[i].InterestAmount_1) + parseFloat(payoutdata[i].InterestAmount_3) +
...
function GetData() {
    ...
    $.ajax({
        ...
        data: {
            ...
            incomedata = data;
            var p_data = new Array();
            var total = 0, t1 = 0, t2 = 0, t3 = 0, t4 = 0, status;
                ...
                for (var J = 1; J <= 12; J++) {
                    ...
                    for (var i = 0; i < incomedata.length; i++) {
                        if (incomedata[i].YearMonth == oldyear + "-" + (J >= 10 ? J : "0" + J)) {
                            ...
                            t3 += parseFloat(incomedata[i].InterestAmout_3)+parseFloat(incomedata[i].PenaltyAmount_3);
                            t4 += parseFloat(incomedata[i].ReceiveValue); //活动收益
                            total += parseFloat(incomedata[i].InterestAmout_1 + incomedata[i].InterestAmout_2 + incomedata[i].InterestAmout_3);//+ incomedata[i].ReceiveValue
                            total += parseFloat(incomedata[i].PenaltyAmount_3);
                            switch (oldIndex) {
                                case 0:
                                    p_data.push(parseFloat(Round2(parseFloat(incomedata[i].InterestAmout_1)+parseFloat(incomedata[i].InterestAmout_2) + parseFloat(incomedata[i].InterestAmout_3) + parseFloat(incomedata[i].PenaltyAmount_3))));//+ incomedata[i].ReceiveValue
                                    break;
                                case 1:
                                ...
                                case 2:
                                    ...
                                    break;
                                case 3:
                                    p_data.push(parseFloat(incomedata[i].InterestAmout_3) + parseFloat(incomedata[i].PenaltyAmount_3));
                                    break;
                                case 4:
                                    p_data.push(parseFloat(incomedata[i].ReceiveValue));
                                    break;
                            }
                            break;
                        }
                ...
                for (var j = 1; j <= 12; j++) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        if (data[i].YearMonth == year + "-" + (j >= 10 ? j : "0" + j)) {
                            t1 += parseFloat(data[i].InterestAmount_2);
                            t2 += parseFloat(data[i].InterestAmount_1) + parseFloat(data[i].InterestAmount_3) +
                                parseFloat(data[i].PenaltyAmount_3) + parseFloat(data[i].Penalty_4);
                            if (oldIndex == 0) {
                                p_data.push(parseFloat(Round2(parseFloat(data[i].InterestAmount_2))));
                            } else {
                                p_data.push(parseFloat(data[i].InterestAmount_1) + parseFloat(data[i].InterestAmount_3) +
                                    parseFloat(data[i].PenaltyAmount_3) + parseFloat(data[i].Penalty_4));
                            }
                            s = 1;
                            break;
